...
//To test compile:
//gcc -c ar2rc.c -O2 -std=c99 -Wall -Wextra
//clang -c ar2rc.c -O2 -std=c99 -Weverything
//g++ -c ar2rc.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c ar2rc.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
