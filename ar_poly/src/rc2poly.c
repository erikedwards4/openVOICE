...
//To test compile:
//gcc -c rc2poly.c -O2 -std=c99 -Wall -Wextra
//clang -c rc2poly.c -O2 -std=c99 -Weverything
//g++ -c rc2poly.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c rc2poly.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
