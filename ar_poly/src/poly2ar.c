...
//To test compile:
//gcc -c poly2ar.c -O2 -std=c99 -Wall -Wextra
//clang -c poly2ar.c -O2 -std=c99 -Weverything
//g++ -c poly2ar.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c poly2ar.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
