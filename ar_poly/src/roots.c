...
//In long run, may have to change CMLI to use NI instead of I.

//To test compile:
//gcc -c roots.c -O2 -std=c99 -Wall -Wextra
//clang -c roots.c -O2 -std=c99 -Weverything
//g++ -c roots.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c roots.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
