...
//To test compile:
//gcc -c poly.c -O2 -std=c99 -Wall -Wextra
//clang -c poly.c -O2 -std=c99 -Weverything
//g++ -c poly.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c poly.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
