//To test compile:
//gcc -c zscore.c -O2 -std=c99 -Wall -Wextra
//clang -c zscore.c -O2 -std=c99 -Weverything
//g++ -c zscore.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c zscore.c -O2 -std=c++11 -Weverything
