//To test compile:
//gcc -c stdev1.c -O2 -std=c99 -Wall -Wextra
//clang -c stdev1.c -O2 -std=c99 -Weverything
//g++ -c stdev1.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c stdev1.c -O2 -std=c++11 -Weverything
