...
//To test compile:
//gcc -c ac2rc.c -O2 -std=c99 -Wall -Wextra
//clang -c ac2rc.c -O2 -std=c99 -Weverything
//g++ -c ac2rc.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c ac2rc.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
