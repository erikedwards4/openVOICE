...
//Recall that FFT is order N*log(N), instead of N*N for autocov.
...
//To test compile:
//gcc -c autocov_fft.c -O2 -std=c99 -Wall -Wextra
//clang -c autocov_fft.c -O2 -std=c99 -Weverything
//g++ -c autocov_fft.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c autocov_fft.c -O2 -std=c++11 -Weverything
...
int autocov_fft_s (float *Y, const float *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in autocov_fft_s: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in autocov_fft_s: ncols X must be positive\n"); return 1; }
    if (dim==0 && L>R) { fprintf(stderr,"error in autocov_fft_s: nlags must be < nrows X for dim==0\n"); return 1; }
    if (dim==1 && L>C) { fprintf(stderr,"error in autocov_fft_s: nlags must be < ncols X for dim==1\n"); return 1; }
    ...
    if (!fplan || !iplan) { fprintf(stderr,"error in autocov_fft_s: problem creating fftw plan"); return 1; }
    ...
    {
        fprintf(stderr,"error in autocov_fft_s: dim must be 0 or 1.\n"); return 1;
    }
...
int autocov_fft_d (double *Y, const double *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    const double z = 0.0;
    int r, c, l, f, nfft, F;
    double *X1, *Y1;
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in autocov_fft_d: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in autocov_fft_d: ncols X must be positive\n"); return 1; }
    if (dim==0 && L>R) { fprintf(stderr,"error in autocov_fft_d: nlags must be < nrows X for dim==0\n"); return 1; }
    if (dim==1 && L>C) { fprintf(stderr,"error in autocov_fft_d: nlags must be < ncols X for dim==1\n"); return 1; }
    ...
    if (!fplan || !iplan) { fprintf(stderr,"error in autocov_fft_d: problem creating fftw plan"); return 1; }
    ...
    {
        fprintf(stderr,"error in autocov_fft_d: dim must be 0 or 1.\n"); return 1;
    }
...
int autocov_fft_c (float *Y, const float *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in autocov_fft_c: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in autocov_fft_c: ncols X must be positive\n"); return 1; }
    if (dim==0 && L>R) { fprintf(stderr,"error in autocov_fft_c: nlags must be < nrows X for dim==0\n"); return 1; }
    if (dim==1 && L>C) { fprintf(stderr,"error in autocov_fft_c: nlags must be < ncols X for dim==1\n"); return 1; }
    ...
    if (!fplan || !iplan) { fprintf(stderr,"error in autocov_fft_c: problem creating fftw plan"); return 1; }
    ...
    {
        fprintf(stderr,"error in autocov_fft_c: dim must be 0 or 1.\n"); return 1;
    }
...
int autocov_fft_z (double *Y, const double *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in autocov_fft_z: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in autocov_fft_z: ncols X must be positive\n"); return 1; }
    if (dim==0 && L>R) { fprintf(stderr,"error in autocov_fft_z: nlags must be < nrows X for dim==0\n"); return 1; }
    if (dim==1 && L>C) { fprintf(stderr,"error in autocov_fft_z: nlags must be < ncols X for dim==1\n"); return 1; }
    ...
    if (!fplan || !iplan) { fprintf(stderr,"error in autocov_fft_z: problem creating fftw plan"); return 1; }
    ...
    {
        fprintf(stderr,"error in autocov_fft_z: dim must be 0 or 1.\n"); return 1;
    }
