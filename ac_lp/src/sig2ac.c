...
//To test compile:
//gcc -c sig2ac.c -O2 -std=c99 -Wall -Wextra
//clang -c sig2ac.c -O2 -std=c99 -Weverything
//g++ -c sig2ac.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c sig2ac.c -O2 -std=c++11 -Weverything
...
int sig2ac_s (float *Y, const float *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in sig2ac_s: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in sig2ac_s: ncols X must be positive\n"); return 1; }
...
int sig2ac_d (double *Y, const double *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in sig2ac_d: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in sig2ac_d: ncols X must be positive\n"); return 1; }
...
int sig2ac_c (float *Y, const float *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in sig2ac_c: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in sig2ac_c: ncols X must be positive\n"); return 1; }
...
int sig2ac_z (double *Y, const double *X, const char iscolmajor, const int R, const int C, const int dim, const int L, const char unbiased)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in sig2ac_z: nrows X must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in sig2ac_z: ncols X must be positive\n"); return 1; }
