//To test compile:
//gcc -c autocorr.c -O2 -std=c99 -Wall -Wextra
//clang -c autocorr.c -O2 -std=c99 -Weverything
//g++ -c autocorr.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c autocorr.c -O2 -std=c++11 -Weverything
    ...
    if (dim==0)
    {
        ...
        if (iscolmajor)
        {
            ...
            for (c=0; c<C; c++)
            {
                ...
                s = 1.0f / cblas_cdotu(R,&X1[0],1,&X1[0],1);
                for (l=1; l<L; l++)
                {
    ...
    else if (dim==1)
    {
        ...
        if (iscolmajor)
        {
            ...
            for (r=0; r<R; r++)
            {
                ...
                s = 1.0f / cblas_cdotu(C,&X1[0],1,&X1[0],1);
                for (l=1; l<L; l++)
                {
    ...
    if (dim==0)
    {
        ...
        if (iscolmajor)
        {
            ...
            for (c=0; c<C; c++)
            {
                ...
                s = 1.0 / cblas_zdotu(R,&X1[0],1,&X1[0],1);
                for (l=1; l<L; l++)
                {
    ...
    else if (dim==1)
    {
        ...
        if (iscolmajor)
        {
            ...
            for (r=0; r<R; r++)
            {
                ...
                s = 1.0 / cblas_zdotu(C,&X1[0],1,&X1[0],1);
                for (l=1; l<L; l++)
                {
