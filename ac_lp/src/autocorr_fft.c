...
//To test compile:
//gcc -c autocorr_fft.c -O2 -std=c99 -Wall -Wextra
//clang -c autocorr_fft.c -O2 -std=c99 -Weverything
//g++ -c autocorr_fft.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c autocorr_fft.c -O2 -std=c++11 -Weverything -Wold-style-cast
