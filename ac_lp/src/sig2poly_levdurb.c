...
//To test compile:
//gcc -c sig2poly_levdurb.c -O2 -std=c99 -Wall -Wextra
//clang -c sig2poly_levdurb.c -O2 -std=c99 -Weverything
//g++ -c sig2poly_levdurb.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c sig2poly_levdurb.c -O2 -std=c++11 -Weverything
