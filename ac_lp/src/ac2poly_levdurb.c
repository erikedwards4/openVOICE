...
//To test compile:
//gcc -c ac2poly_levdurb.c -O2 -std=c99 -Wall -Wextra
//clang -c ac2poly_levdurb.c -O2 -std=c99 -Weverything
//g++ -c ac2poly_levdurb.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c ac2poly_levdurb.c -O2 -std=c++11 -Weverything
