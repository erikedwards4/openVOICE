...
//To test compile:
//gcc -c pow_compress.c -O2 -std=c99 -Wall -Wextra
//clang -c pow_compress.c -O2 -std=c99 -Weverything
//g++ -c pow_compress.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c pow_compress.c -O2 -std=c++11 -Weverything
