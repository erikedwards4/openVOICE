...
//To test compile:
//gcc -c get_cns.c -O2 -std=c99 -Wall -Wextra
//clang -c get_cns.c -O2 -std=c99 -Weverything
//g++ -c get_cns.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c get_cns.c -O2 -std=c++11 -Weverything
