...
//To test compile:
//gcc -c spectrogram.c -O2 -std=c99 -Wall -Wextra
//clang -c spectrogram.c -O2 -std=c99 -Weverything
//g++ -c spectrogram.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c spectrogram.c -O2 -std=c++11 -Weverything
