...
//To test compile:
//gcc -c apply_spectrogram_T_mat.c -O2 -std=c99 -Wall -Wextra
//clang -c apply_spectrogram_T_mat.c -O2 -std=c99 -Weverything
//g++ -c apply_spectrogram_T_mat.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c apply_spectrogram_T_mat.c -O2 -std=c++11 -Weverything
