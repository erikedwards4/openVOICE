...
int main(int argc, char *argv[])
{
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ square -n256 X -o Y \n";
    descr += "$ square -n256 -d1 X > Y \n";
    descr += "$ cat X | square -n256 > Y \n";
