...
int main(int argc, char *argv[])
{
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ abs -n256 X -o Y \n";
    descr += "$ abs -n256 -d1 X > Y \n";
    descr += "$ cat X | abs -n256 > Y \n";
