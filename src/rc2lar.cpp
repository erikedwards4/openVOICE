...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "Gets log area ratios (LARs) from reflection coefficients (RCs).\n";
    descr += "The output (Y) has the same size and data type as X.\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ rc2lar X -o Y \n";
    descr += "$ rc2lar X > Y \n";
    descr += "$ cat X | rc2lar > Y \n";
