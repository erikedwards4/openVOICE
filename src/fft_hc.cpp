...
int main(int argc, char *argv[])
{
    ...
    descr += "format of fftw3. This is a somewhat more efficient format that\n";
    descr += "still has all of the info for the nonnegative FFT freqs.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ fft_hc -n256 X -o Y \n";
    descr += "$ fft_hc -n256 -d1 X > Y \n";
    descr += "$ cat X | fft_hc -n256 > Y \n";
