...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "Gets reflection coefficients (RCs) from log area ratios (LARs).\n";
    descr += "The output (Y) has the same size and data type as X.\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ lar2rc X -o Y \n";
    descr += "$ lar2rc X > Y \n";
    descr += "$ cat X | lar2rc > Y \n";
