...
//This doesn't currently compile under g++ or clang++,
//since cmp_ascend_s and cmp_ascend_d are in namespace ov.

//To test compile:
//gcc -c poly2lsf.c -O2 -std=c99 -Wall -Wextra
//clang -c poly2lsf.c -O2 -std=c99 -Weverything
