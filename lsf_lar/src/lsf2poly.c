...
//To test compile:
//gcc -c lsf2poly.c -O2 -std=c99 -Wall -Wextra
//clang -c lsf2poly.c -O2 -std=c99 -Weverything
//g++ -c lsf2poly.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c lsf2poly.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
