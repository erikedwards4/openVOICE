...
//To test compile:
//gcc -c lsf2ar.c -O2 -std=c99 -Wall -Wextra
//clang -c lsf2ar.c -O2 -std=c99 -Weverything
//g++ -c lsf2ar.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c lsf2ar.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
