...
//To test compile:
//gcc -c window_univar.c -O2 -std=c99 -Wall -Wextra
//clang -c window_univar.c -O2 -std=c99 -Weverything
//g++ -c window_univar.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c window_univar.c -O2 -std=c++11 -Weverything
