//To test compile:
//gcc -c apply_win.c -O2 -std=c99 -Wall -Wextra
//clang -c apply_win.c -O2 -std=c99 -Weverything
//g++ -c apply_win.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c apply_win.c -O2 -std=c++11 -Weverything
