...
//To test compile:
//gcc -c frame_univar.c -O2 -std=c99 -Wall -Wextra
//clang -c frame_univar.c -O2 -std=c99 -Weverything
//g++ -c frame_univar.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c frame_univar.c -O2 -std=c++11 -Weverything
