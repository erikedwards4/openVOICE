//To test compile:
//gcc -c rms_scale.c -O2 -std=c99 -Wall -Wextra
//clang -c rms_scale.c -O2 -std=c99 -Weverything
//g++ -c rms_scale.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c rms_scale.c -O2 -std=c++11 -Weverything
