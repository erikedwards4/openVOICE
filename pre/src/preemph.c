//To test compile:
//gcc -c preemph.c -O2 -std=c99 -Wall -Wextra
//clang -c preemph.c -O2 -std=c99 -Weverything
//g++ -c preemph.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c preemph.c -O2 -std=c++11 -Weverything
