...
//To test compile:
//gcc -c lcr.c -O2 -std=c99 -Wall -Wextra
//clang -c lcr.c -O2 -std=c99 -Weverything
//g++ -c lcr.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c lcr.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
