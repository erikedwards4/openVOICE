...
//To test compile:
//gcc -c zero_crossings.c -O2 -std=c99 -Wall -Wextra
//clang -c zero_crossings.c -O2 -std=c99 -Weverything
//g++ -c zero_crossings.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c zero_crossings.c -O2 -std=c++11 -Weverything
