...
//To test compile:
//gcc -c mcr_windowed.c -O2 -std=c99 -Wall -Wextra
//clang -c mcr_windowed.c -O2 -std=c99 -Weverything
//g++ -c mcr_windowed.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c mcr_windowed.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
