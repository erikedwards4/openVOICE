...
//To test compile:
//gcc -c mcr.c -O2 -std=c99 -Wall -Wextra
//clang -c mcr.c -O2 -std=c99 -Weverything
//g++ -c mcr.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c mcr.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
