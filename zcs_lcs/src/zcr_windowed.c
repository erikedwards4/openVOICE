...
//To test compile:
//gcc -c zcr_windowed.c -O2 -std=c99 -Wall -Wextra
//clang -c zcr_windowed.c -O2 -std=c99 -Weverything
//g++ -c zcr_windowed.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c zcr_windowed.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
