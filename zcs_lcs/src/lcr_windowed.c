...
//To test compile:
//gcc -c lcr_windowed.c -O2 -std=c99 -Wall -Wextra
//clang -c lcr_windowed.c -O2 -std=c99 -Weverything
//g++ -c lcr_windowed.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c lcr_windowed.c -O2 -std=c++11 -Weverything -Wno-old-style-cast
