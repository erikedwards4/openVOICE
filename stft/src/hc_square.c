...
//To test compile:
//gcc -c hc_square.c -O2 -std=c99 -Wall -Wextra
//clang -c hc_square.c -O2 -std=c99 -Weverything
//g++ -c hc_square.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c hc_square.c -O2 -std=c++11 -Weverything
