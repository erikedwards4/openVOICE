...
//To test compile:
//gcc -c fft_squared.c -O2 -std=c99 -Wall -Wextra
//clang -c fft_squared.c -O2 -std=c99 -Weverything
//g++ -c fft_squared.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c fft_squared.c -O2 -std=c++11 -Weverything
