...
//To test compile:
//gcc -c lifter.c -O2 -std=c99 -Wall -Wextra
//clang -c lifter.c -O2 -std=c99 -Weverything
//g++ -c lifter.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c lifter.c -O2 -std=c++11 -Weverything
