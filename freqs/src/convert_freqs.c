...
//To test compile:
//gcc -c convert_freqs.c -O2 -std=c99 -Wall -Wextra
//clang -c convert_freqs.c -O2 -std=c99 -Weverything
//g++ -c convert_freqs.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c convert_freqs.c -O2 -std=c++11 -Weverything
