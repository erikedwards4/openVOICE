...
//To test compile:
//gcc -c add_deltas.c -O2 -std=c99 -Wall -Wextra
//clang -c add_deltas.c -O2 -std=c99 -Weverything
//g++ -c add_deltas.c -O2 -std=c++11 -Wall -Wextra
//clang++ -c add_deltas.c -O2 -std=c++11 -Weverything
